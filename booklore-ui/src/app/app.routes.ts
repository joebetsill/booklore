...
import { OfflineBooksComponent } from './features/book/components/offline-books/offline-books.component';
...
export const routes: Routes = [
  ...
  { path: 'oauth2-callback', component: OidcCallbackComponent },
  {
    ...
    children: [
      ...
      { path: 'offline-books', component: OfflineBooksComponent, canActivate: [AuthGuard] },
    ]
  },
  {
